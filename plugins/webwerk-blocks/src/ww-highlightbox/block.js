 ...
 */
registerBlockType( 'ww/highlightbox', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
  title: 'WW - Highlightbox', // Block title.
  ...
  attributes: {
    ...
    function ContentsSPW() {
      ...
      if (section_class && pagewrap_class)  {
        ...
        pagewrap_class = 'page-wrap img-btn ' + pagewrap_class;
      } else if (section_class) {
        section_class = 'section ' + section_class;
        pagewrap_class = 'page-wrap img-btn';
